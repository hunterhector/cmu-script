...
eval_dir="../cmu-script-j1.6/data/mention/kbp/LDC2015E95/eval/full_run/"
gold_predicted=${eval_dir}"gold_coref_all.tbf"
sys_predicted=${eval_dir}"lv1_realis_coref_all.tbf"
gold_base="../cmu-script-j1.6/data/mention/LDC/LDC2015R26/data/"
gold_standard=${gold_base}"tbf/EvalEventHopper20150903.tbf"
token_dir=${gold_base}"tkn"
log_file_base="../cmu-script-j1.6/logs/kbp/eval/tree_coref/final"
